...
var KEY = 'pt_key=app_openAAJjGpPsADAB6vzsoCCgi1DYEyeqEr2krzUQYHLz5PvNPynG45AzDKdiM-aR1in4WcXgusMH4RE; pt_pin=jd_5cff0a1f544fb; pwdt_id=jd_5cff0a1f544fb; ';
...
function notify() {
  return new Promise(resolve => {
    try {
      ...
      pushMsg('京东签到',Name + one + two + three + four + five + disa + notify)
